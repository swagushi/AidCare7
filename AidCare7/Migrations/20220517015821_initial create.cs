            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    donationID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DonationDescription = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    donationAmount = table.Column<int>(type: "int", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    membereventId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    membereventName = table.Column<string>(type: "nvarchar(max)", nullable: true),
